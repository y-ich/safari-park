...
(function() {
  var base, baseOf, dependencies, fileOf, get, layout, loadBackstage, loadCSS, loadCodeMirror, loadScript, loadTargets, ready, setBackstage, site, sourceTargets, targets, typeOf;
  ...
  layout = function(files) {
    var child, childNodes, container, count, editor, front, i, tab, _ref, _ref2;
    ...
    return document.getElementById('frontstage').addEventListener('click', function() {
