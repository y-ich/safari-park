...
(function() {
  var base, baseOf, defaultCMOptions, dependencies, fileOf, get, layout, loadBackstage, loadCSS, loadCodeMirror, loadScript, overwrite, preventPageScroll, ready, setBackstage, site, sourceTargets, targets, typeOf,
  ...
  preventPageScroll = function(codemirror) {
    ...
    $(codemirror.getInputField()).bind('mousedown', function() {
      return codemirror.bodyTop = document.body.scrollTop;
    });
    return $(codemirror.getInputField()).bind('focus', function() {
